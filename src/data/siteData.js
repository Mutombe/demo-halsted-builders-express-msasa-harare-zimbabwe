...
const siteData = {
  business: {
    name: "Halsted Builders Express - Msasa | Harare Zimbabwe",
    legalName: "Halsted Builders Express - Msasa | Harare Zimbabwe",
    tagline: "Quality Building Materials & Hardware Supplies",
    description: "Halsted Builders Express - Msasa | Harare Zimbabwe has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
    phone: "+263 78 182 4212",
    phoneRaw: "+263781824212",
    whatsappNumber: "263781824212",
    email: "info@halstedbuildersexpre.co.zw",
    address: "116 Mutare Rd, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 4.2,
    ratingRounded: 4,
    ...
    cookieConsentKey: "halsted-builders-express-msasa-harare-zimbabwe-cookie-consent",
    socialLinks: { facebook: "https://www.facebook.com/HalstedBuildersExpressZimbabwe/", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Halsted", logoLine2: "Builders Express" },
  ...
  hero: {
    ...
    trustBadge: "816+ Customer Reviews",
    backgroundImages: [
  ...
  stats: [
    { number: "816+", label: "Customer Reviews" },
    { number: "50+", label: "Years Trusted" },
  ...
  homeTestimonials: [
    ...
    { text: "Bulk delivery is always on time and the prices are competitive. Halsted Builders Express - Msasa | Harare Zimbabwe is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Halsted Builders Express - Msasa | Harare Zimbabwe has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
  ...
  reviews: {
    ...
    items: [
      { text: "Halsted Builders Express - Msasa | Harare Zimbabwe has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5 },
      ...
      { text: "Bulk delivery is always on time and the prices are competitive. Halsted Builders Express - Msasa | Harare Zimbabwe is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Halsted Builders Express - Msasa | Harare Zimbabwe exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Halsted Builders Express - Msasa | Harare Zimbabwe to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Halsted Builders Express - Msasa | Harare Zimbabwe is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Halsted Builders Express - Msasa | Harare Zimbabwe has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Halsted Builders Express - Msasa | Harare Zimbabwe! I would like to request a quote.",
