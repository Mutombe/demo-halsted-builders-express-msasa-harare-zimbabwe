  ...
  return (
    <section className="relative bg-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-36 pb-20 relative z-20">
        <div className="grid lg:grid-cols-5 gap-12 items-center min-h-[65vh]">
          <div className="lg:col-span-3">
            ...
            <div className="overflow-hidden">
              <motion.h1 initial={{ y: '100%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.4, ease: [0.16, 1, 0.3, 1] }}
                className="font-heading text-gray-900 leading-[0.92] tracking-tight" style={{ fontSize: 'clamp(2.2rem, 7vw, 4.5rem)' }}>
                WHY TRADE<br /><span className="text-green-600 italic font-bold">WITH US?</span>
              </motion.h1>
            </div>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="mt-6 space-y-3">
              {['Wholesale & retail pricing', 'Free delivery on bulk orders', 'Expert advice on every project', 'All major brands stocked'].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <CheckCircle size={16} weight="fill" className="text-green-500 shrink-0" />
                  <span className="text-gray-600 text-sm" style={{ fontFamily: 'var(--font-sans)' }}>{item}</span>
                </div>
              ))}
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }} className="flex flex-wrap gap-4 mt-8">
              ...
              <a href={`tel:${business.phoneRaw}`} className="group inline-flex items-center gap-3 border border-gray-300 text-gray-600 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-green-500 hover:text-green-600 transition-all" style={{ fontFamily: 'var(--font-sans)' }}>
                <Phone size={18} /> {business.phone}
              </a>
            </motion.div>
          </div>
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.3 }} className="lg:col-span-2 relative">
            <div className="overflow-hidden aspect-[3/4]">
              <img src={heroImages[0]} alt="Hardware store" className="w-full h-full object-cover object-center" loading="eager" />
            </div>
            <div className="absolute -top-3 -left-3 w-16 h-16 border-t-2 border-l-2 border-green-400/40" />
            <div className="absolute -bottom-3 -right-3 w-16 h-16 border-b-2 border-r-2 border-green-400/40" />
          </motion.div>
        </div>
      </div>
    </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The Halsted<br /><span className="text-green-500">Story</span>
            </h2>
            {about.story.map((p, i) => (
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-green-500">Halsted</span>
            </h2>
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={siteData.hero.backgroundImages[0]?.url} alt="Halsted Builders Express - Msasa | Harare Zimbabwe" className="w-full h-[130%] object-cover object-center" loading="lazy" />
